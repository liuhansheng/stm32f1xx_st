...
/* Determine if preemption-threshold should be disabled. By default, preemption-threshold is
   ...
   定义后, 将禁用抢占阈值功能, 并略微减小代码大小并提高性能. 当然, 抢占阈值功能不再可用.
*/
 ...
 * 使用 System Tick 做时钟源
 */
#define TX_TRACE_TIME_SOURCE ((*(ULONG *)0xe000e014) - (*(ULONG *)0xe000e018))
#define TX_TRACE_TIME_MASK   0x00ffffff
#endif
...
#define TX_THREAD_PRIORITY_UART6_RX     10
#define TX_THREAD_PRIORITY_UART6_TX     10
#define TX_THREAD_PRIORITY_UAVCAN_TX    15
#define TX_THREAD_PRIORITY_UAVCAN_RX    14
#define TX_THREAD_PRIORITY_CAN1_RX      14
#define TX_THREAD_PRIORITY_CAN2_RX      14
#define TX_THREAD_PRIORITY_ADC          20

#define TX_THREAD_PRIORITY_UAVCAN_RADIO 25
#define TX_THREAD_PRIORITY_TEST         28
#define TX_THREAD_PRIORITY_IDLE         (TX_MAX_PRIORITIES - 1)
